...
from merger_science1 import merger
import os



if __name__ == "__main__":
    pathname = "D:\\joohyung\\google_drive_backup\\joohyung\\성대\\3학년\\1학기\\캡스톤\\제1과학관 데이터_수정"
    remove_ext_folder(pathname)
    move_excel_file(pathname)
    xls_to_csv(pathname)
    column_changer(pathname)
    merger(pathname, "science1_combined_dataset.csv")